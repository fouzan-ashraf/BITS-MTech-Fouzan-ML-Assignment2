...
with tab1:
    ...
    st.info("👉 **Ready to test the models?** Click on the **'🚀 Model Inference and Evaluation'** tab at the top of the page to download/upload test data and perform evaluations or generate predictions.")
