...
st.markdown("<h2 style='font-size: 32px; font-weight: bold; margin-bottom: 0px; padding-top: 0px;'>Machine Learning Classification Model Comparison - Breast Cancer Diagnosis</h2>", unsafe_allow_html=True)
